...
```text
math.proportion.sravnit_dve_proportion
```
...
```md
- `math.proportion.sravnit_dve_proportion` — сравнить две пропорции
```
...
```ts
{
  id: "math.proportion.sravnit_dve_proportion",
...
```json
{
  "id": "math.proportion.sravnit_dve_proportion.000001",
  "topic_id": "math.proportion",
  "skill_id": "math.proportion.sravnit_dve_proportion",
  "difficulty": 2,
